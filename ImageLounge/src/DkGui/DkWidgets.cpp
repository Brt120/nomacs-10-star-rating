...
void DkRatingLabel::init()
{
    ...
    mStars[rating_3] = new DkButton(starWhite, starDark, tr("three stars"), this);
    mStars[rating_3]->setCheckable(true);
    connect(mStars[rating_3], SIGNAL(released()), this, SLOT(rating3()));

    mStars[rating_4] = new DkButton(starWhite, starDark, tr("four stars"), this);
    mStars[rating_4]->setCheckable(true);
    connect(mStars[rating_4], SIGNAL(released()), this, SLOT(rating4()));

    mStars[rating_5] = new DkButton(starWhite, starDark, tr("five stars"), this);
    mStars[rating_5]->setCheckable(true);
    connect(mStars[rating_5], SIGNAL(released()), this, SLOT(rating5()));

    mStars[rating_6] = new DkButton(starWhite, starDark, tr("six stars"), this);
    mStars[rating_6]->setCheckable(true);
    connect(mStars[rating_6], SIGNAL(released()), this, SLOT(rating6()));

    mStars[rating_7] = new DkButton(starWhite, starDark, tr("seven stars"), this);
    mStars[rating_7]->setCheckable(true);
    connect(mStars[rating_7], SIGNAL(released()), this, SLOT(rating7()));

    mStars[rating_8] = new DkButton(starWhite, starDark, tr("eight stars"), this);
    mStars[rating_8]->setCheckable(true);
    connect(mStars[rating_8], SIGNAL(released()), this, SLOT(rating8()));

    mStars[rating_9] = new DkButton(starWhite, starDark, tr("nine stars"), this);
    mStars[rating_9]->setCheckable(true);
    connect(mStars[rating_9], SIGNAL(released()), this, SLOT(rating9()));

    mStars[rating_10] = new DkButton(starWhite, starDark, tr("ten stars"), this);
    mStars[rating_10]->setCheckable(true);
    connect(mStars[rating_10], SIGNAL(released()), this, SLOT(rating10()));
}
    ...
    : DkRatingLabel(rating, parent, flags)
{
    ...
    mStars[rating_6]->addAction(am.action(DkActionManager::sc_star_rating_6));
    connect(am.action(DkActionManager::sc_star_rating_6), SIGNAL(triggered()), this, SLOT(rating6()));
    mStars[rating_7]->addAction(am.action(DkActionManager::sc_star_rating_7));
    connect(am.action(DkActionManager::sc_star_rating_7), SIGNAL(triggered()), this, SLOT(rating7()));
    mStars[rating_8]->addAction(am.action(DkActionManager::sc_star_rating_8));
    connect(am.action(DkActionManager::sc_star_rating_8), SIGNAL(triggered()), this, SLOT(rating8()));
    mStars[rating_9]->addAction(am.action(DkActionManager::sc_star_rating_9));
    connect(am.action(DkActionManager::sc_star_rating_9), SIGNAL(triggered()), this, SLOT(rating9()));
    mStars[rating_10]->addAction(am.action(DkActionManager::sc_star_rating_10));
    connect(am.action(DkActionManager::sc_star_rating_10), SIGNAL(triggered()), this, SLOT(rating10()));
