...
void DkActionManager::createActions(QWidget *parent)
{
    ...
    mHiddenActions[sc_star_rating_6] = new QAction(QObject::tr("Star Rating 6"), parent);
    mHiddenActions[sc_star_rating_6]->setStatusTip(QObject::tr("Star rating which is saved to an image's metadata"));
    mHiddenActions[sc_star_rating_6]->setShortcut(QKeySequence(shortcut_star_rating_6));

    mHiddenActions[sc_star_rating_7] = new QAction(QObject::tr("Star Rating 7"), parent);
    mHiddenActions[sc_star_rating_7]->setStatusTip(QObject::tr("Star rating which is saved to an image's metadata"));
    mHiddenActions[sc_star_rating_7]->setShortcut(QKeySequence(shortcut_star_rating_7));

    mHiddenActions[sc_star_rating_8] = new QAction(QObject::tr("Star Rating 8"), parent);
    mHiddenActions[sc_star_rating_8]->setStatusTip(QObject::tr("Star rating which is saved to an image's metadata"));
    mHiddenActions[sc_star_rating_8]->setShortcut(QKeySequence(shortcut_star_rating_8));

    mHiddenActions[sc_star_rating_9] = new QAction(QObject::tr("Star Rating 9"), parent);
    mHiddenActions[sc_star_rating_9]->setStatusTip(QObject::tr("Star rating which is saved to an image's metadata"));
    mHiddenActions[sc_star_rating_9]->setShortcut(QKeySequence(shortcut_star_rating_9));

    mHiddenActions[sc_star_rating_10] = new QAction(QObject::tr("Star Rating 10"), parent);
    mHiddenActions[sc_star_rating_10]->setStatusTip(QObject::tr("Star rating which is saved to an image's metadata"));
    mHiddenActions[sc_star_rating_10]->setShortcut(QKeySequence(shortcut_star_rating_10));
